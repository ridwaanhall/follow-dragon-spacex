...
function initPreloader() {
    issTexture = textureLoader.load("/follow-dragon/img/icon_iss.png");
    dragonTexture = textureLoader.load("/follow-dragon/img/icon_dragon.png");
    dragonIssTexture = textureLoader.load("/follow-dragon/img/icon_dragon_iss.png");
	if (deviceSettings.isMobile) {
		earthTexture = textureLoader.load("/follow-dragon/img/earth/EarthTexture_2048.jpg");
		earthGlowTexture = textureLoader.load("/follow-dragon/img/glow_mobile.jpg");
	} else {
		earthTexture = textureLoader.load("/follow-dragon/img/earth/EarthTexture_2048.jpg");
		earthGlowTexture = textureLoader.load("/follow-dragon/img/glow.jpg");
	}
...
function objectTrackerLoop() {
    ...
    request.setRequestHeader('Accept-Language', 'en-US,en;q=0.9,mt;q=0.8');
    request.setRequestHeader('DNT', '1'); // Do Not Track header
    request.setRequestHeader('Origin', 'https://www.spacex.com');
    request.setRequestHeader('Referer', 'https://www.spacex.com/');
    request.setRequestHeader('User-Agent', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36 Edg/128.0.0.0');
    request.setRequestHeader('Sec-CH-UA', '"Chromium";v="128", "Not;A=Brand";v="24", "Microsoft Edge";v="128"');
